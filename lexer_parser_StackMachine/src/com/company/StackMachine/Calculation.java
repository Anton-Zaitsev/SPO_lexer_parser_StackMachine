...
import com.company.MyCollection.MyHashSet;
...
public class Calculation {
    ...
    public static void calculate(LinkedList<Token> Calc) {
            ...
            if (token.type == Lexem.FUNC_OP) {
                ...
                if (types.get(t1.data).equals("List")) {
                    if (t2.type == Lexem.NUM) {
                        switch (token.data) {
                            case "add" -> ((MyLIST) values.get(t1.data)).add(t2.data);
                            case "get" -> stack.add(new Token(Lexem.NUM, (String) ((MyLIST) values.get(t1.data)).get(Integer.parseInt(t2.data))));
                            case "remove" -> ((MyLIST) values.get(t1.data)).remove(Integer.parseInt(t2.data));
                            case "contains" -> ((MyLIST) values.get(t1.data)).contains(t2.data);
                        }
                    }
                    else if (t2.type == Lexem.VAR) {
                        switch (token.data) {
                            case "add" -> ((MyLIST) values.get(t1.data)).add(values.get(t2.data));
                            case "get" -> stack.add(new Token(Lexem.NUM, (String) ((MyLIST) values.get(t1.data)).get((Integer) values.get(t2.data))));
                            case "remove" -> ((MyLIST) values.get(t1.data)).remove((Integer) (values.get(t2.data)));
                            case "contains" -> stack.add(new Token(Lexem.BOOL, Boolean.toString(((MyLIST) values.get(t1.data)).contains(values.get(t2.data)))));
                        }
                    }
                }
                else if (types.get(t1.data).equals("Set")) {
                    if (t2.type == Lexem.NUM) {
                        switch (token.data) {
                            case "add" -> ((MyHashSet) values.get(t1.data)).add(t2.data);
                            case "remove" -> ((MyHashSet) values.get(t1.data)).remove(Integer.parseInt(t2.data));
                            case "contains" -> ((MyHashSet) values.get(t1.data)).contains(t2.data);
                        }
                    }
                    else if (t2.type == Lexem.VAR) {
                        switch (token.data) {
                            case "add" -> ((MyHashSet) values.get(t1.data)).add(values.get(t2.data));
                            case "remove" -> ((MyHashSet) values.get(t1.data)).remove(values.get(t2.data));
                            case "contains" -> stack.add(new Token(Lexem.BOOL, Boolean.toString(((MyHashSet) values.get(t1.data)).contains(values.get(t2.data)))));
                        }
                    }
                }
            }
